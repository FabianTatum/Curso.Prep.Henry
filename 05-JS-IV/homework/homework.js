...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var valorNumero = objetoMisterioso.numeroMisterioso;
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  var objLikes = usuario['posts'];
  var suma = 0;
  for(var o = 0; o < objLikes.length; o++){
    suma = suma + objLikes[o].likes;
  }
  return suma
}
